...
class Projector:
    ...
    def get_theprojector_cinemas(self):
    ...
    def get_theprojector_movies(self):
        movies = []
    ...
    def parse_data(self):
        ...
        for movie in self.movies:
            ...
            if self.day_filter_hit(movie_time):
...
def theprojector_parser(filename: str, day: int):
    ...
    projector.add_cinema_location()
    projector.parse_data()
